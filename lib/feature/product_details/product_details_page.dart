...
class _ProductDetailScreen extends State<ProductDetailScreen> {
  ...
  void productDetails() async {
    var resData = await apiProvider.getProductDetails();
    log(resData.data!.toString());
    setState(() {
      productDetailsModel = resData;
    });
  }
              ...
              children: [
                Column(
                  ...
                  children: [
                    ...
                    Text(
                      "Whether you’re a novice looking to microdose or an experienced user after a mega-dose – you’ve come to the right place",
                      style: TextStyle(
                          fontSize: 16,
                          fontWeight: FontWeight.normal,
                          color: Colors.black),
